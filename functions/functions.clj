...
(inc 1)
(let [x 1] (+ x 1))
((fn [x] (+ x 1)) 1) ;; (fn [x] (+ x 1)) equivalent to #(+ % 1)
(#(+ % 1) 1)
(let [increment #(+ % 1)] (increment 1))

(let [twice #(* 2 %)] (+ (twice 1) (twice 3)))
;; equivalent to
(+ (* 2 1) (* 2 3))
...
;;named functions
(defn twice ([number] (* 2 number)) ([] (* 2)))
(twice 3)
(twice)

(defn vargs [x y & more-args] {:x x :y y :more more-args})
(vargs 1 3)
(vargs 1 3 5 7 9)
